...
import com.muhajirlatif.maps.Helper.FetchURL;
import com.muhajirlatif.maps.Helper.TaskLoadedCallback;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGetDirection.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                new FetchURL(MapsRouteActivity.this).execute(getUrl(place1.getPosition(), place2.getPosition(), "driving"), "driving");
            }
        });
